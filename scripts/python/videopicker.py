...
#"./files/d/2019-10-19", "./files/d/2019-10-27", "./files/e/2019-10-05", "./files/e/2019-09-28", "./files/e/2019-09-21", "./files/e/2019-09-14"
folders = ["./files/d/2019-10-12"]
...
for folder in folders:
	...
	for index, randomFile in enumerate(randomFiles):
		print(str(round(time.time() - startTime)) + " uploading " + index + ": " + randomFile)
